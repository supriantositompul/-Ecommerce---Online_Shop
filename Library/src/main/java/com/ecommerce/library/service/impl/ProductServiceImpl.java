...
public class ProductServiceImpl implements ProductService {
    ...
    private Page<ProductDto> toPage(List<ProductDto> list, Pageable pageable) {
        ...
        int endIndex = Math.min((int) (pageable.getOffset() + pageable.getPageSize()), list.size());
    ...
    private List<ProductDto> transferData(List<Product> products) {
        ...
        for (Product product : products) {
            productDtos.add(transferData(product));
        }
        return productDtos;
    }

    private ProductDto transferData(Product product) {
